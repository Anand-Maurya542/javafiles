...
//        SimpleKey s=new SimpleKey();
//        s.setSize(new Dimension(200, 150));
//        s.setTitle("SimpleKey");
//        s.setVisible(true);
//    }
//
//
...
//demonstration of some virtual keycodes
    ...
    public void keyPressed(KeyEvent ke) {
        ...
        switch(key){
            ...
            case KeyEvent.VK_PAGE_DOWN:
                msg += "<PgDn>";
                break;case KeyEvent.VK_PAGE_UP:
                msg += "<PgUp>";
                break;
